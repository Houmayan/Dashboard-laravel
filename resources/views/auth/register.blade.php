                            ...
                            <form method="POST" action="{{ route('register') }}">
                                ...
                                <div class="form-group mb-3 row">
                                    <div class="col-12">
                                        ...
                                        name="password" class="form-control" type="password" required="" placeholder="password">
                                    </div>
                                </div>
                                <div class="form-group mb-3 row">
                                    <div class="col-12">
                                        ...
                                        type="password"
                                        name="password_confirmation" class="form-control" required="" placeholder="password">
                                    </div>
                                </div>
                                {{-- username --}}
